    %% Select ROI's in each cell (3 ROI's per cell of 2 x 2 micrometers)
...
Size_ROI_size=4000;%Enter the size of your ROI (in nm), e.g Size_ROI_size=2000 for a 2000nm x 2000nm ROI
...
for CurrentTableID=StartingTable:TotalNumberofDataTables;
 ...
 for CurrentRegionID=1:TotalNumberOfReg
            ...
            mkdir(foldername1)
            foldername=[foldername1,'/data_channel1.txt'] % change here number of channel depeding on the Img
